        ...
        <main class="main-content">
            ...
            <div class="content-container">
                ...
                <div class="mb-3">
                    ...
                    <a href="{{ route('students.index') }}" class="btn btn-outline-primary custom-btn">
                ...
                <div class="section-card mt-4">
                    ...
                    <div class="credential-box mt-4">
                        ...
                        <div class="credential-actions">
                            ...
                            <button type="button" id="togglePasswordButton" class="btn btn-outline-primary custom-btn mt-2"
                                onclick="togglePassword()">
                                Tampilkan Password
                            </button>


                            <button type="button" class="btn btn-primary custom-btn mt-2" onclick="toggleChangePassword()">
                                Ubah Password
                            </button>
                    ...
                    <div id="changePasswordForm" class="change-password-box mt-4" style="display: none;">
                        ...
                        <form action="{{ route('students.updatePassword', $student) }}" method="POST">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="form-control custom-input" placeholder="Masukkan ulang password" required>
